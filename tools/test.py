...
from davarocr.davar_common.apis import single_gpu_test
from davarocr.davar_common.apis import multi_gpu_test
...
def main():
    ...
    if rank == 0:
        ...
        if args.eval:
            ...
            print(results)
            with open(cfg.work_dir + "results_coco_vsr.json", "w") as file:
